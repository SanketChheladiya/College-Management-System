...
<div class="card_box">
  ...
  <div class="id_box_body">
    ...
    <div class="id_title">Student ID</div>
    <div style="margin-top: 8px;"></div>
      <div class="field">
	      ...
	      <div class="name_field">    
	      	<span class="id_field">College :</span>
	      	<span class="inf"><?php echo "$title"; ?></span>
	      </div>

	      <div class="name_field">    
	      <span class="id_field">Mobile :</span> <span class="inf"><?php echo "$father_mobile"; ?></span>
	      </div>
        <div class="name_field">    
        <span class="id_field">Entry Barcode -↓</span> <span class="inf"><?php echo "$barcode"; ?>↓</span>
        </div>
	      <div class="name_field">    
