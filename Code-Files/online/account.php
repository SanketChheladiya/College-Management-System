...
<?php if(@$_GET['q']==1) {
$email = $_SESSION["email"];
$result = mysqli_query($con,"SELECT distinct quiz.title,quiz.eid,quiz.total,quiz.sahi,quiz.wrong,quiz.time,quiz.eid FROM quiz INNER JOIN ( examstu INNER JOIN user ON examstu.email='$email' ) ON examstu.eid=quiz.eid ORDER BY date DESC");
if (!$result) 
{
    printf("Error: %s\n", mysqli_error($con));
...
<tr style="color:black"><td><b>S.N.</b></td><td><b>Topic</b></td><td><b>Exam id</b></td><td><b>Total question</b></td><td><b>Marks</b></td><td><b>positive</b></td><td><b>negative</b></td><td><b>Time limit</b></td><td></td><td></td></tr>';
$c=1;
...
{
echo '<tr style="color:#99cc32"><td>'.$c++.'</td><td>'.$title.'</td><td>'.$eid.'&nbsp;<span title="This quiz is already solve by you" class="glyphicon glyphicon-ok" aria-hidden="true"></span></td><td>'.$total.'</td><td>'.$sahi*$total.'</td><td>'.$sahi.'</td><td>'.$wrong.'</td><td>'.$time.'&nbsp;min</td>
  </tr>';
}
}
$c=0;
...
echo  '<div class="panel title">
<table class="table table-striped title1" >
<tr style="color:black"><td><b>Rank</b></td><td><b>Name</b></td><td><b>Gender</b></td><td><b>rollno</b></td><td><b>Score</b></td></tr>';
$c=0;
while($row=mysqli_fetch_array($q) )
{
$e=$row['email'];
