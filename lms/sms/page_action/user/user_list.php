...
{
  $site->form_input("User Name","fname","up_full_name","text","exclamation-sign","","","yes");
  ...
  $site->form_input("permission","per","up_per","per","exclamation-sign","","","yes");

  echo "<button style='width: 100%' class='btn btn-primary' onclick=add_user()><b>Update Info</b></button>";
