...
<div class="containerr register" style="padding: 8px">
                <div class="row">
                    <div class="col-md-4 col-sm-12 register-left">
                        ...
                        <div style="margin-top: -65px;"><img src="upload/custom_content/admin.jpg" style="height: 80px;width: 300px;border-radius: 15px;" alt=""/></div>
                        
                        <b style="font-size: 25px;">Sanket</b>
                        <div style="margin-top: 46px;"></div>
                        
                        <a href="http://google.com"><input type="submit" name="" value="Google"/></a><br/>
                    </div>
