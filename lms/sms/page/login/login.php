...
<body style="background-size: 100%; background-image: 'bgimgnu.jpg'">
  ...
  <div class="row">
    ...
    <div id="login-box" style="margin-top: 45px;">
        ...
        <div class="controls" id="login_body">  
            ...
            <button type="submit" id="login_btn" onclick="login()" name="login" class="btn btn-default btn-block btn-custom">Login</button> 
        </div>
        <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="page/login/fopassward.php">forgot password? </a>
        <div class="footer_login" style="">Developed By: <a href="http://google.com"><font style="font-size: 19px;font-weight: bold;color: #F64343">Sanket</font></a></div>
    </div>
